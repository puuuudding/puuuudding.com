        ...
        stage("Update container") {
            ...
            steps {
                script {
                    ...
                    sshCommand remote: remote, command: "cd /home/${SSH_CRED_USR}/puuuudding.com && git fetch && git reset origin/master --hard && docker-compose pull && docker-compose up -d --build --no-deps"
                }
            }
        }
    }
